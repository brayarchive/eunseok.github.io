...
{
  index: 0,
  headline: 'Age of Experience',
  button: 'Read now',
  src: './img/bol.jpg' },

{
  index: 1,
  headline: 'Dream is real',
  button: 'Read now',
  src: './img/neon.jpg' },

{
  index: 2,
  headline: 'Goodbye CES 2020!',
  button: 'Read now',
  src: './img/osh.jpg' },
...
class Slide extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("button", { className: "slide__action btn",onClick:()=> window.location.href = index+".html" }, button))));
